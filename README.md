...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/make-a-pic)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/make-a-pic
```

A live public deployment of this template is available at [https://make-a-pic.templates.workers.dev](https://make-a-pic.templates.workers.dev)
